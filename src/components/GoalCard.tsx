    ...
    <>
      <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        ...
        <View style={styles.progressRow}>
          ...
          <View style={{ flex: 1 }} />
          <Text style={[styles.pct, { color: reached ? colors.success : colors.primary }]} numberOfLines={1}>%{pct.toFixed(0)}</Text>
        </View>

        <View style={[styles.barTrack, { backgroundColor: colors.surfaceAlt }]}>
          <View style={[styles.barFill, { width: `${pct}%`, backgroundColor: reached ? colors.success : colors.primary }]} />
        </View>
      </View>
      {renderModal()}
    </>
        ...
        <Pressable style={styles.backdrop} onPress={() => setEditing(false)}>
          <Pressable style={[styles.modal, { backgroundColor: colors.surface, borderColor: colors.border }]} onPress={() => {}}>
            ...
            <View style={styles.modalRow}>
              ...
              <Pressable onPress={onSave} disabled={saving} style={[styles.btn, { flex: 1, backgroundColor: colors.primary }]}>
